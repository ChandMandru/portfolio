...
function SocialLinkItem({ link }: { link: SocialLink }) {
  ...
  return (
    <a
      ...
      className="flex items-center gap-2 text-muted-foreground hover:text-blue-500 dark:hover:text-blue-400 transition-colors duration-150 min-h-[44px] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
    >
      <SocialIcon icon={link.icon} />
      <span className="text-sm text-current">{link.platform}</span>
    </a>
  );
}
